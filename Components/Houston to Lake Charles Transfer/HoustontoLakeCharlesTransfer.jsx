...
const Houstontolakecharles = () => {
  ...
  const data =
    houston_to_lakecharles_page &&
    houston_to_lakecharles_page.houstonToLakeCharles[0];
  const faqs = houston_to_lakecharles_page && houston_to_lakecharles_page.faqs;
  const fleet =
    houston_to_lakecharles_page && houston_to_lakecharles_page.fleet;
  const cityWeServe =
    houston_to_lakecharles_page && houston_to_lakecharles_page.cityWeServe;
